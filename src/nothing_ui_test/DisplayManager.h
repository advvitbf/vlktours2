...
private:
    ...
    void drawUiChrome(const char *label);
    void drawListItem(uint8_t index, const char *label, bool selected);
    void drawMetricRow(int16_t y, const char *label, const String &value);
